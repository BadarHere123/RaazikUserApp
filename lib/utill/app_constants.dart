...
class AppConstants {
  static const String APP_NAME = 'Raazik';
  static const String BASE_URL = 'https://raazik.pk/admin/auth/login';
  ...
  static List<LanguageModel> languages = [
    ...
    LanguageModel(imageUrl: '', languageName: 'Urdu', countryCode: 'PK', languageCode: 'ur'),
  ];
}
